<template>
  <div class="diplomas">
    <div class="diplomas_item" v-for="diploma in diplomas">
      <router-link :to="{ name: 'Diploma', params: { id: diploma.id } }">
    ...
    <form v-if="form" id="file-form" enctype="multipart/form-data" action="http://127.0.0.1:8000/create_diploma" method="post" @submit.prevent="createNewDiploma">
...
<script>
  ...
  name: 'diplomas',
    ...
    methods: {
      getDiplomas(){
        soso.search('diplomas').then(resp => {
